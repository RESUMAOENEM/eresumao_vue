...
<template>
  <div>
    ...
    <div>
      <!--Materia-->
      <b-dropdown id="dropdown-dropright" dropright text="História" variant="primary" class="center m-5">
      ...
      <!-- Materia -->
      <b-dropdown id="dropdown-dropright" dropright text="não sei" variant="primary" class="center m-5">
      <b-dropdown-item href="#">efwfGuerra Mundial</b-dropdown-item>
      <b-dropdown-item href="#">qfwefwf</b-dropdown-item>
      <b-dropdown-item href="#">Revolução Industrial</b-dropdown-item>
      </b-dropdown>
